...
[quote, bpmn.io, https://bpmn.io/toolkit/bpmn-js/]
____
...
[bpmn, "bpmn-internal-example-diagram", svg]
----
...
bpmn::{imagesdir}/asciidoctor-diagrams_overview/uml/bpmn.bpmn[format="svg"]
